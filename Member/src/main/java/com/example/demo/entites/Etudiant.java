...
public class Etudiant extends Membre implements Serializable{
	...
	public Etudiant(String nom, String prenom, String cin, String cv, String email, String password, Date date,
	...
	public EnseignantChercheur getEncadrant(EnseignantChercheur encadrant) {
		return encadrant;
	}
